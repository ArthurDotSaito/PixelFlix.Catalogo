...
public class UpdateGenreTest
{
    ...
    [Fact(DisplayName = nameof(GivenAUpdateGenreCommand_whenUpdateWithoutCategories_shouldUpdate))]
    [Trait("Application", "UpdateGenre - Use Cases")]
    public async Task GivenAUpdateGenreCommand_whenUpdateWithoutCategories_shouldUpdate()
    {
        var genreRepositoryMock = _fixture.GetGenreRepositoryMock();
        var unitOfWorkMock = _fixture.GetUnitOfWorkMock();
        var categoryRepositoryMock = _fixture.GetCategoryRepositoryMock();
    ...
    [Fact(DisplayName = nameof(GivenAUpdateGenreCommand_whenUpdateWithEmptyCategoryList_shouldUpdateToaEmptyList))]
    [Trait("Application", "UpdateGenre - Use Cases")]
    public async Task GivenAUpdateGenreCommand_whenUpdateWithEmptyCategoryList_shouldUpdateToaEmptyList()
    {
        var genreRepositoryMock = _fixture.GetGenreRepositoryMock();
        var unitOfWorkMock = _fixture.GetUnitOfWorkMock();
        var categoryRepositoryMock = _fixture.GetCategoryRepositoryMock();
        ...
        var input = new UpdateGenreRequest(aGenre.Id, newName, newIsActive, new List<Guid>());
